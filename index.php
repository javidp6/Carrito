        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="Productos.php">Graficas</a>
                </h4>
                <p class="card-text"></p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="Productos.php">Placas base</a>
                </h4>
                <p class="card-text"></p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="Productos.php">Procesadores</a>
                </h4>
                <p class="card-text"></p>
              </div>
            </div> 
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="Productos.php">Memoria Ram</a>
                </h4>
                <p class="card-text"></p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="Productos.php">Discos Duros</a>
                </h4>
                <p class="card-text"> </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="Productos.php"><img class="card-img-top" src="img/portatil.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Portatiles</a>
                </h4>
